class Locality < ActiveRecord::Base
  ...
  def demographic_metadata
    ...
    basics = {
      ...
      "military_success" => registrants.where(voter_outcome: "VotedAbsentee", is_active_duty_uniformed_services: true).count,
      "military_rejected" => registrants.where(voter_outcome: "RejectedAbsentee", is_active_duty_uniformed_services: true).count,
      "military_dep_success" => registrants.where(voter_outcome: "VotedAbsentee", is_eligible_military_spouse_or_dependent: true).count,
      "military_dep_rejected" => registrants.where(voter_outcome: "RejectedAbsentee", is_eligible_military_spouse_or_dependent: true).count,
      "intent_to_return_success" => registrants.where(voter_outcome: "VotedAbsentee", is_residing_abroad_with_intent_to_return: true).count,
      "intent_to_return_rejected" => registrants.where(voter_outcome: "RejectedAbsentee", is_residing_abroad_with_intent_to_return: true).count,
      "uncertain_return_success" => registrants.where(voter_outcome: "VotedAbsentee", is_residing_abroad_uncertain_return: true).count,
      "uncertain_return_rejected" => registrants.where(voter_outcome: "RejectedAbsentee", is_residing_abroad_uncertain_return: true).count,
